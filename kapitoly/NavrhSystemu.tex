...
Ide o druhú generáciu hĺbkových kamier od spoločnosti Microsoft. Oproti prvej generácií využíva technológiu ToF (detailnejšie v \ref{sec:tof}), pričom ide o jednu z najznámejších senzorov tohto typu na svete \cite{wiki:kinect}. Rozsah snímanej scény je $0.5-4.5 m$. Farebný obraz je dodávaný v rozlíšení $1920\times1080p$ a $30Hz$, hĺbková mapa ma rozlíšenie $512\times424$.
...
\begin{table}[H]
	...
	\begin{tabular}{cccc}
		\toprule
		\textbf{Model} & \textbf{Počet vzdialenosti [-]} & \textbf{Priemer [mm]} & \textbf{RMS [mm]} \\ 
		\midrule
...
\begin{figure}[H]
	...
	\caption{Sekvencia spracovania prijatých dát z jednotlivých kamier vykonávané v samostatnom vlákne.}
	\label{fig:scheme:c}
\end{figure}
