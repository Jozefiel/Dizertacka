...
\include{Seznam_Zkratek}
\include{Seznam_Symbolu}
...
\usepackage[defernumbers=true,style=numeric, sorting=none]{biblatex}
%\addbibresource{bibliografie.bib}
\addbibresource{bibliografia.tex}
...
%	--
	...
	% Jednotlive kapitoly
	\include{kapitoly/Podakovanie}
	\include{kapitoly/Abstrakt}
	\include{kapitoly/Uvod}
	\include{kapitoly/Motivacia}
	\include{kapitoly/TechPozadie}
	\include{kapitoly/Kalibracia}
	\include{kapitoly/Tezy}
	\include{kapitoly/NavrhSystemu}
%	\include{kapitoly/Interferencia}

	\include{kapitoly/Zaver}
	\include{kapitoly/Zhodnotenie}
	\include{kapitoly/Publikacie}
...
%	\bibliography{VlastniClanky}

	\include{kapitoly/Prilohy}
	
	\printbibliography[title={Zoznam publikačnej činnosti},resetnumbers=true]
